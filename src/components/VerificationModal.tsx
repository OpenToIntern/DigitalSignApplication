...
export default function VerificationModal({ result, onClose }: VerificationModalProps) {
  ...
  return (
    <div className="modal-overlay">
      <div className="modal-content max-w-xl bg-white border border-outline-variant p-6 sm:p-8 text-left">
        {/* Header */}
        ...
        <div className="glass-card bg-surface-container-low border border-outline-variant/60 p-4 mb-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between gap-3">
              ...
              <code className="text-xs font-mono text-on-surface bg-surface-container-lowest border border-outline-variant/40 px-2 py-1 rounded truncate">
            ...
            <div className="flex items-center justify-between gap-3">
              ...
              <code className={`text-xs font-mono px-2 py-1 rounded truncate border
                ${result.valid ? 'text-emerald-700 bg-emerald-50 border-emerald-100' : 'text-red-700 bg-red-50 border-red-100'}`}>
